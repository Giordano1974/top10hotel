...
if (have_posts()) :
    while (have_posts()) : the_post();
        $destinazioni = get_the_terms($post->ID , 'destinazioni' );
        $paesaggi = get_the_terms($post->ID , 'paesaggi' );
...
?>
            ...
            <main id="site-content" class="main-content">
                <article id="post-<?php echo $post->ID ?>" class="post-<?php echo $post->ID ?> post type-post has-post-thumbnail entry single-entry">
                    <header class="has-gradient-overlay page-header entry-header single-entry-header alignfull parallax-background">
                        <div class="entry-media single-entry-media">
                            <div class="post-thumbnail header-background">
                                <picture>
                                    <source srcset="<?php echo get_the_post_thumbnail_url( $post->ID,'mia_extra_large' )?>" media="(min-width: 1535px)">
                                    <source srcset="<?php echo get_the_post_thumbnail_url( $post->ID ,'mia_large')?>" media="(min-width: 1024px)">
                                    <source srcset="<?php echo get_the_post_thumbnail_url( $post->ID ,'mia_medium')?>" media="(min-width: 600px)">
                                    <img width="600" height="400" src="<?php echo get_the_post_thumbnail_url( $post->ID,'mia_rect' )?>" class="attachment-tripp-fullwidth size-tripp-fullwidth wp-post-image" alt="<?php echo get_the_title();?>" decoding="async" />
                                </picture>
                            </div>
                        </div>
                        <div class="header-content">
                            <div class="tripp-container">
                                ...
                                <span class="description"><?php echo get_field('sommario',$post->ID);?></span>
                        ...
                        <nav class="content-index__menu" role="menu">
                            <ul>
                                <?php while( have_rows('aggiungi_hotel') ): the_row(); 
                                    ...
                                    $anchor = "hotel-" . get_row_index();
                                ?> 
                                <li>
                                    <a href="#<?php echo $anchor ?>" role="menuitem" title="scrolla a <?php echo $nomeHotel ?> "><h4><?php echo $nomeHotel ?></h4></a>
                                    <span>&nbsp;<?php echo $sottotitoloHotel ?></span>
                                </li>
                                <?php endwhile; ?>
                            </ul>
                        </nav>                                    
                    ...
                    if( have_rows('aggiungi_hotel') ): ?>
                        ...
                        <?php while( have_rows('aggiungi_hotel') ): the_row();
                            ...
                            <section id="<?php echo $anchor ?>" class="hotel-item">
                                <div class="hotel-item__title">
                                    <h2><a href="<?php echo $linkHotel; ?>" target="_blank"><?php echo $nomeHotel; ?></a></h2>
                                </div>
                                <div class="hotel-item__meta">
                                    <strong><em><span style="font-size: 19px"><?php echo $sottotitoloHotel; ?></span></em></strong>
                                ...
                                <?php 
                                if( $photogallery ): ?>
                                    <div class="flext-block-gallery alignfull">
                                                            <div class="flext-carousel-gallery flext-carousel-gutters" data-slides-per-view="1" data-gutters="l" data-autoplay="true" data-loop="true" data-centered-slides="true" data-navigation="true" data-pagination="true">
                                ...
                                <div class="cta-container">
                                    <button style="display:none" class="text-read-more"></button>
                                    <a href="<?php echo $linkHotel; ?>" title="Visita <?php echo $imgHotel["title"] ?> su Booking.com" target="_blank" class="hotel-cta"><?php echo _e('vedi_info_e_tariffe', 'top10hotel');?>
                    ...
                    <div class="flext-post-carousel flext-carousel posts-list" data-navigation="1" data-slides-per-view="3" data-space-between="30">
                        ...
                        if ( $query->have_posts() ) {
                            while ( $query->have_posts() ) {
                                ...
                                ?>
                                <article class="flext-slide post-<?php echo $post->ID; ?> post type-post has-post-thumbnail hentry has-review entry">
                                        ...
                                        <div class="flext-featured-media flext-post-gallery flext-gallery-slider" data-autoplay="hover">
                                            <div class="flext-carousel-wrapper">
                                                ...
                                                if ($gallery_images) {
                                                        ...
                                                        <a href="<?php the_permalink(); ?>" class="flext-slide">
                                                        <img width="480" height="640" src="<?php echo get_the_post_thumbnail_url( $post->ID,"mia_vert" );?>" class="attachment-tripp-large size-tripp-large" alt="<?php echo $alt_text; ?>" decoding="async" loading="lazy" />
                                                        </a>
                                        ...
                                        <header class="entry-header">
                                            <div class="entry-meta">
                                                <span class="meta-destination term-links">
                                                    ...
                                                    $destinations = get_the_terms( $post->ID, 'destinazioni' );
